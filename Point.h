...
private:
     ...
     * @details Содержит значение координаты по горизонтальной оси в декартовой системе координат
     */
    double x;

    /*
     * @brief Координата Y точки
     * @details Содержит значение координаты по вертикальной оси в декартовой системе координат
     */
    double y;
